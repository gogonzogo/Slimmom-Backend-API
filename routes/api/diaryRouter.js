...
const { ctrlWrapper, authorizeUser } = require("../../middlewares");
...
diaryRouter
  .route("/diary/allFoods/search/:title")
  .get(authorizeUser, ctrlWrapper(ctrl.diaryAllFoodsSearch));
diaryRouter
  .route("/badFood")
  .get(authorizeUser, ctrlWrapper(ctrl.diaryNotAllowedFoodsSearch));
